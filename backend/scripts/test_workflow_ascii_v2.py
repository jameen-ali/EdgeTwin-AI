...
def test_workflow():
    ...
    users = {
        "admin": {"email": "admin@edgetwin.ai", "password": "password123"},
        "operator": {"email": "operator@edgetwin.ai", "password": "password123"},
        "manager": {"email": "manager@edgetwin.ai", "password": "password123"},
        "mechanic": {"email": "technician@edgetwin.ai", "password": "password123"}
    }
