...
def test_workflow():
    ...
    users = {
        "admin": {"email": "admin@edgetwin.ai", "password": "EdgeTwin@2026"},
        "operator": {"email": "operator@edgetwin.ai", "password": "EdgeTwin@2026"},
        "manager": {"email": "manager@edgetwin.ai", "password": "EdgeTwin@2026"},
        "mechanic": {"email": "technician@edgetwin.ai", "password": "EdgeTwin@2026"}
    }
